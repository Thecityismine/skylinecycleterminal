---
title: "What Is the Skyline Cycle Score?"
slug: "skyline-cycle-score"
metaTitle: "What Is the Skyline Cycle Score? | Skyline"
description: "The Skyline Cycle Score is one 0–100 read of where Bitcoin sits in its cycle. Here's what it measures and how to use it, accumulation to distribution."
keyword: "skyline cycle score"
secondary:
  - "bitcoin cycle score"
...
The Score is a composite. Under the hood it draws on the same four lenses covered in the pillar guide, [How to Read the Bitcoin Market Cycle](/learn/how-to-read-the-bitcoin-market-cycle):
...
2. **Macro Liquidity**, global liquidity, the dollar (DXY), stablecoin liquidity, and ETF flows: the macro tide that often turns before price (see [Macro Liquidity, Explained](/learn/macro-liquidity-explained)).
3. **On-Chain**, MVRV, SOPR, Puell, HODL Waves, Realized Price, CVDD, and long-term holder supply, the indicators that have historically marked cycle extremes (see [Bottoms](/learn/how-to-identify-bitcoin-bottoms) and [Tops](/learn/how-to-identify-bitcoin-tops)).
...
**[See today's Skyline Cycle Score →](https://skylinecycleterminal.com)**
...
- [Why Bitcoin Moves in Long-Term Cycles](/learn/why-bitcoin-moves-in-cycles): the forces behind the phases
- [How to Identify Bitcoin Bottoms](/learn/how-to-identify-bitcoin-bottoms): the signals that feed the accumulation phase
