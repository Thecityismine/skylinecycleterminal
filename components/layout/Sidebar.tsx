...
const nav: (NavItem | NavSection)[] = [
  ...
  { label: "Deep Research", href: "/research", icon: FileText, exact: true },
  {
    ...
    items: [
      ...
      { label: "Halving Cycles",    href: "/price/halving-cycles",  icon: CalendarDays, free: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "4-Year Cycle",     href: "/price/four-year-cycle",    icon: CalendarDays, free: true },
      { label: "2-Year MA",        href: "/price/two-year-ma",        icon: BarChart3, free: true },
      { label: "100-Week MA",      href: "/price/btc-100w-ma",        icon: TrendingUp },
      { label: "Realized Price",   href: "/price/realized-price",     icon: CircleDollarSign, free: true },
      ...
      { label: "Drawdown / ATH",   href: "/price/drawdown",           icon: TrendingDown, free: true },
      { label: "Yearly Lows",      href: "/price/yearly-lows",        icon: TrendingDown },
      { label: "Liquidity Heatmap", href: "/price/liquidity",          icon: Flame },
      { label: "Pi Cycle Bottom",  href: "/price/pi-cycle-bottom",    icon: TrendingDown, free: true },
      { label: "Hash Ribbons",     href: "/price/hash-ribbons",       icon: Waves, free: true },
      { label: "BTC / M2",        href: "/price/btc-m2",             icon: DollarSign },
      { label: "Power Law",       href: "/price/power-law",          icon: TrendingUp, free: true },
    ],
  },
  {
    section: "ON-CHAIN",
    items: [
      ...
      { label: "SOPR",              href: "/onchain/sopr",              icon: Activity, free: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Altcoin Season",     href: "/altseason",                  icon: Waves, free: true },
      // All three resolve to the public /dominance route — the query string only
      // switches the view — so they carry the same badge.
      { label: "BTC Dominance",      href: "/dominance",                  icon: PieChart,  exact: true, free: true },
      { label: "ETH Dominance",      href: "/dominance?asset=eth",        icon: PieChart,  exact: true, free: true },
      { label: "Total Market Cap",   href: "/dominance?view=total",       icon: BarChart2, exact: true, free: true },
